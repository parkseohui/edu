...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<h3>${place.aptName} 근처 편의시설 입니다.</h3>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=012e53d65597e9d0766e69ea0332b43b&libraries=services"></script>
<script>
